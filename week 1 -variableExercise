...
// num2 but not num1?
// Answer: The value assigned to num1 excludes numbers 1 and 10, while num2 is inclusive of 1 and 10.
// The numbers that will be valid for num2 but not num1 are 1 and 10.
...
const myAnswerForExercise12 = "undefind";
...
//I found this too simple, and i just used the Chrome console to check my answers
