...
function exercise1(num1) {
  ...
  // unexpected case will happen when the two variables have the same value but they have different data types. we should use strict 
    // equality . For example, varA = 13 and varB = "13". 
